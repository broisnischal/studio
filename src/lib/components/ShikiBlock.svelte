...
<div class="relative min-h-0 flex-1 overflow-auto">
  ...
  {:else}
    <div class="shiki-block contents [&_pre]:m-0 [&_pre]:bg-transparent! [&_pre]:p-3 [&_pre]:font-mono [&_pre]:text-[12px] [&_pre]:leading-relaxed [&_pre]:whitespace-pre-wrap [&_pre]:break-all">
      {@html html}
    </div>
  {/if}
</div>
